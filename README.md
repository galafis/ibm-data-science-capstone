...
Este projeto representa o trabalho final do **IBM Data Science**, demonstrando competências avançadas na área. A plataforma desenvolvida oferece uma solução completa e funcional.
...
This project represents the capstone work for the **IBM Data Science**, demonstrating advanced competencies in the field. The developed platform offers a complete and functional solution.
